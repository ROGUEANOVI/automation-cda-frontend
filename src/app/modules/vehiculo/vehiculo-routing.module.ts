...
const routes: Routes = [
  ...
  {path: "create-vehiculo/:idUsuario", component: CreateVehiculoComponent},
  {path: "list-vehiculos/:idUsuario", component: ListVehiculosComponent},
  {path: "edit-vehiculo/:idUsuario/:id", component: EditVehiculoComponent},
];
